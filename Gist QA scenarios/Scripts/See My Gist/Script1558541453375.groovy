...
WebUI.click(findTestObject('Github/GistList/Page_user gists/a_All gists'))

WebUI.verifyElementPresent(findTestObject('Github/GistList/Page_user gists/div_GistList'), 0)
