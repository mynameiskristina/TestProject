...
WebUI.click(findTestObject('Github/Edit Gist/Edit Button'))

WebUI.click(findTestObject('Object Repository/Github/NewGist/Page_Create a new Gist/div_Content'))

WebUI.clearText(findTestObject('Object Repository/Github/NewGist/Page_Create a new Gist/div_Content'))

WebUI.setText(findTestObject('Object Repository/Github/NewGist/Page_Create a new Gist/div_Content'), GlobalVariable.gistContentUpdate)

WebUI.click(findTestObject('Github/Edit Gist/update_gist_button'))
